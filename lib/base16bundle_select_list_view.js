...
class Base16BundleSelectListView extends SelectListView {
  ...
  viewForItem(theme) {
    ...
    if (this.base16.isConfigTheme(theme.scheme, theme.contrastGutter, theme.invertColors)) {
  ...
  selectItemView(view) {
    ...
    if (this.attached) { return this.base16.enableTheme(theme.scheme, theme.contrastGutter, theme.invertColors); }
  }
  ...
  confirmed(theme) {
    ...
    this.base16.setThemeConfig(theme.scheme, theme.contrastGutter, theme.invertColors);
    this.cancel();
  ...
  getThemes() {
    ...
    const contrastGutter = atom.config.get(`${this.base16.packageName}.contrastGutter`);
