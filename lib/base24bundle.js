...
class Base24Bundle {
  ...
  static initClass() {
    ...
    this.prototype.config = require('./base24bundle_settings').config;
  }
  ...
  getSyntaxVariablesContent(scheme, contrastGutter, invertColors) {
    return `\
@base24-scheme: '${this.getNormalizedName(scheme)}';
@base24-contrastGutter: ${contrastGutter};
@base24-invertColors: ${invertColors};

@import "schemes/@{base24-scheme}";
\
`;
  }
  ...
  createSelectListView() {
    const Base24BundleSelectListView = require('./base24bundle_select_list_view');
    const base24BundleSelectListView = new Base24BundleSelectListView(this);
    return base24BundleSelectListView.attach();
  }
...
Base24Bundle.initClass();

module.exports = new Base24Bundle;
